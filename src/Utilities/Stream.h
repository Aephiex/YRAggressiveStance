...
class YRAggressiveStanceStreamReader;
class YRAggressiveStanceStreamWriter;
...
class YRAggressiveStanceByteStream
{
public:
...
public:
	YRAggressiveStanceByteStream(size_t Reserve = 0x1000);
	~YRAggressiveStanceByteStream();
...
class YRAggressiveStanceStreamWorkerBase
{
public:
	explicit YRAggressiveStanceStreamWorkerBase(YRAggressiveStanceByteStream& Stream) :
		stream(&Stream),
		success(true)
	{ }

	YRAggressiveStanceStreamWorkerBase(const YRAggressiveStanceStreamWorkerBase&) = delete;

	YRAggressiveStanceStreamWorkerBase& operator = (const YRAggressiveStanceStreamWorkerBase&) = delete;
...
protected:
	...
	YRAggressiveStanceByteStream* stream;
	bool success;
};

class YRAggressiveStanceStreamReader : public YRAggressiveStanceStreamWorkerBase
{
public:
	explicit YRAggressiveStanceStreamReader(YRAggressiveStanceByteStream& Stream) : YRAggressiveStanceStreamWorkerBase(Stream) { }
	YRAggressiveStanceStreamReader(const YRAggressiveStanceStreamReader&) = delete;

	YRAggressiveStanceStreamReader& operator = (const YRAggressiveStanceStreamReader&) = delete;

	template <typename T>
	YRAggressiveStanceStreamReader& Process(T& value, bool RegisterForChange = true)
	{
		if (this->IsValid(stream_debugging_t()))
			this->success &= Savegame::ReadYRAggressiveStanceStream(*this, value, RegisterForChange);
		return *this;
	}
	...
	bool Read(YRAggressiveStanceByteStream::data_t* Value, size_t Size)
	{
...
class YRAggressiveStanceStreamWriter : public YRAggressiveStanceStreamWorkerBase
{
public:
	explicit YRAggressiveStanceStreamWriter(YRAggressiveStanceByteStream& Stream) : YRAggressiveStanceStreamWorkerBase(Stream) { }
	YRAggressiveStanceStreamWriter(const YRAggressiveStanceStreamWriter&) = delete;

	YRAggressiveStanceStreamWriter& operator = (const YRAggressiveStanceStreamWriter&) = delete;

	template <typename T>
	YRAggressiveStanceStreamWriter& Process(T& value, bool RegisterForChange = true)
	{
		if (this->IsValid(stream_debugging_t()))
			this->success &= Savegame::WriteYRAggressiveStanceStream(*this, value);
	...
	void Write(const YRAggressiveStanceByteStream::data_t* Value, size_t Size)
	{
